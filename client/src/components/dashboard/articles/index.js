...
const AdminArticles = () => {
    ...
    //middle man to rmb which item to remove with _id:
        ...
        <div className='articles_table'>
            ...
            <Modal show={removeAlert} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Are you really sure you want to remove the item?</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    There is no going back once item removed!
                </Modal.Body>
                <Modal.Footer>
