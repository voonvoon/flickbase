...
export const addArticle = createAsyncThunk(
    ...
    async(article,{ dispatch })=>{
        try{
            ...
            dispatch(successGlobal('Post succesffully created! good job buddy!'))
            return request.data;
        } catch(error){
...
export const changeStatusArticle = createAsyncThunk(
    ...
    async({newStatus,_id},{ dispatch,getState })=>{
        try{
            ...
            //we can't mutate 'let state' so we create a copy:
...
export const addCategory = createAsyncThunk(
    ...
    async(data,{ dispatch, getState })=>{
        try{
            ...
            dispatch(successGlobal('Successfully updated category!'))
